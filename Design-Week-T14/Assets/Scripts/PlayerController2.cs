...
public class PlayerController2 : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        // D-Pad Left
        controls.Player2.MoveLeft.performed += ctx => { moveInput = -1f; playerAudio.movementSource.Play(); };
        controls.Player2.MoveLeft.canceled += ctx => ResetMoveInput();

        // D-Pad Right
        controls.Player2.MoveRight.performed += ctx => { moveInput = 1f; playerAudio.movementSource.Play(); };
